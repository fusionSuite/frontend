...
@Component({
  selector: 'app-workflowFusioninventoryPanel',
  templateUrl: './workflowFusioninventoryPanel.component.html',
})
export class WorkflowFusioninventoryPanelComponent implements OnChanges {
  ...
  public formControls = new FormGroup({
    ...
    inventoryentry: new FormControl(false, {
      validators: [],
    }),
    history: new FormControl(false, {
      validators: [],
    }),
    maxhistory: new FormControl(20, {
      validators: [],
    }),
    typefilter: new FormControl('', {
      validators: [],
    }),
    treefiltering: new FormControl(false, {
      validators: [],
    }),
